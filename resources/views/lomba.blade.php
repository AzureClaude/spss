...
<img src="<?php echo asset('storage/assets/images/pola2.png') ?>" alt="" id="back-image-top">
...
<div class="row">
    ...
    <div class="penjelasan-header">
        ...
        <div style="margin-top: 8px;">
            <a class="btn btn-outline-success fit-content-btn" href="#">Unduh syarat dan ketentuan</a>
    ...
    <div class="gallery-bg text-center w-100">
        ...
        <div class="gallery-photo">
            <img src="<?php echo asset('storage/assets/images/FotoLomba.png') ?>" class="w-100">
        </div>
        <div class="gallery-photo">
            <img src="<?php echo asset('storage/assets/images/FotoLomba.png') ?>" class="w-100">
        </div>
        ...
        <img src="<?php echo asset('storage/assets/images/pola1.png') ?>" style="width: 70%;">
        </div>
    </div>
    </div>
    ...
    <div class="countdown-lomba">
        ...
        <div>
        <img src="<?php echo asset('storage/assets/images/total-hadiah.png') ?>" class="total-hadiah">
        </div>
    </div>

    <div class="text-center col-lg-12 col-md-12">
        <article class="penjelasan-text text-white">Linimasa</article>
        <img src="<?php echo asset('storage/assets/images/spss-timeline.PNG') ?>" class="w-100" style="margin-top: 20px;">
    </div>
    </div>
</div>
</div>
