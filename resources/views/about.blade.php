...
<div class="container">
    ...
    <div class="col-lg-6 col-md-12 text-center">
        <video src="<?php echo asset('storage/assets/video/video-test.mp4')?>" controls class="w-100 video" style="display: none;"></video>
        <img src="<?php echo asset('storage/assets/images/play-button.png')?>" class="play-btn">
    </div>
