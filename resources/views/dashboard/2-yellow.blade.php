...
<article class="sub-heading text-white" style="font-size: calc(8px + 1em);">Silahkan unduh soal tahap 2 <a href="#" class="link">disini</a>.</article><br />
...
<form action="#" id="Tahap2Form">
    <article class="sub-heading text-white" style="font-size: calc(8px + 1em);">Unggah jawaban anda : </article>
    <div class="form-group" style="margin-top: 12px;">
    <label for="JawabanTahap2" class="btn btn-outline-success fit-content-btn" style="margin: 4px 0 0;">Choose file</label>
    <span id="FileJawaban2" class="text-white"></span>
    <input type="file" class="form-control" id="JawabanTahap2" style="display: none;">
    </div>
...
<script>
    $(document).on('change', '#JawabanTahap2', function (event) {
    $('#FileJawaban2').html(event.target.files[0].name);
    });
</script>
@endsection