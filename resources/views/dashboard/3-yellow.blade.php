...
<article class="sub-heading text-white" style="font-size: calc(8px + 1em);">Silahkan unduh soal tahap 3 <a href="#" class="link">disini</a>.</article><br />
...
<form action="#" id="Tahap3Form">
    <article class="sub-heading text-white" style="font-size: calc(8px + 1em);">Unggah jawaban anda : </article>
    <div class="form-group" style="margin-top: 12px;">
    <label for="JawabanTahap3" class="btn btn-outline-success fit-content-btn" style="margin: 4px 0 0;">Choose file</label>
    <span id="FileJawaban3" class="text-white"></span>
    <input type="file" class="form-control" id="JawabanTahap3" style="display: none;">
    </div>
...
<script>
    $(document).on('change', '#JawabanTahap3', function (event) {
    $('#FileJawaban3').html(event.target.files[0].name);
    });
</script>
@endsection