    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <form class="form-inline mt-2 mt-md-0" style="margin: 0 -15px;">
            <a class="nav-link text-white" >Nama Peserta</a>
            <a class="btn btn-outline-light fit-content-btn" href="#">Keluar</a>
          </form>
        </div>
      </nav>
    </header>
